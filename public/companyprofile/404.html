...
<head>
    ...
    <!-- favicons Icons -->
    <link rel="apple-touch-icon" sizes="180x180" href="assets/Photos/PRO1LOGO (2).png" />
    <link rel="icon" type="image/png" sizes="32x32" href="assets/Photos/PRO1LOGO (2).png" />
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
                        ...
                        <div class="main-menu__wrapper-inner clearfix">
                            <div class="main-menu__left">
                                <div class="main-menu__logo">
                                    <a href="index-boxed.html"><img src="assets/Photos/PRO1LOGO (2).png" alt=""></a>
                                </div>
        ...
        <section class="error-page">
            <div class="error-page-shape-1 float-bob-y" style="background-image: url(assets/images/shapes/error-page-shape-1.png);">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="error-page__inner">
                            ...
                            <a href="index-boxed.html" class="thm-btn error-page__btn">Back to Home</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp " data-wow-delay="100ms ">
                            <div class="footer-widget__column footer-widget__about ">
                                <div class="footer-widget__logo ">
                                    <a href="index-boxed.html "><img src="assets/Photos/footerlogo.png " alt=" " width="200px " height="70px "></a>
                                </div>
                                ...
                                <ul class="footer-widget__gallery-list list-unstyled clearfix ">
                                    <li class="col-md-4 ">
                                        ...
                                        <div class="footer-widget__gallery-img ">
                                            ...
                                            <img src="assets/Photos/sc-fb8.png " alt=" ">
                                    ...
                                    <li class="col-md-4 ">
                                        <div class="footer-widget__gallery-img ">
                                            <img src="assets/Photos/sc-vb6.png " alt=" ">
