...
<head>
    ...
    <!-- favicons Icons -->
    <link rel="apple-touch-icon" sizes="180x180" href="{{asset('companyprofile/assets/images/favicons/apple-touch-icon.png')}}" />
    <link rel="icon" type="image/png" sizes="32x32" href="{{asset('companyprofile/assets/Photos/PRO1LOGO (2).png')}}" />
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('companyprofile/assets/Photos/PRO1LOGO (2).png')}}" />
    <link rel="manifest" href="{{asset('companyprofile/assets/images/favicons/site.webmanifest')}}" />
    ...
    <link rel="stylesheet" href="{{asset('companyprofile/assets/vendors/bootstrap/css/bootstrap.min.css')}}" />
    <link rel="stylesheet" href="{{asset('companyprofile/assets/vendors/animate/animate.min.css')}}" />
    <link rel="stylesheet" href="{{asset('companyprofile/assets/vendors/animate/custom-animate.css')}}" />
    <link rel="stylesheet" href="{{asset('companyprofile/assets/vendors/fontawesome/css/all.min.css')}}" />
    <link rel="stylesheet" href="{{asset('companyprofile/assets/vendors/jarallax/jarallax.css')}}" />
    <link rel="stylesheet" href="{{asset('companyprofile/assets/vendors/jquery-magnific-popup/jquery.magnific-popup.css')}}" />
    <link rel="stylesheet" href="{{asset('companyprofile/assets/vendors/jquery-magnific-popup/jquery.magnific-popup.css')}}" />
    <link rel="stylesheet" href="{{asset('companyprofile/assets/vendors/nouislider/nouislider.min.css')}}" />
    <link rel="stylesheet" href="{{asset('companyprofile/assets/vendors/nouislider/nouislider.pips.css')}}" />
    <link rel="stylesheet" href="{{asset('companyprofile/assets/vendors/odometer/odometer.min.css')}}" />
    <link rel="stylesheet" href="{{asset('companyprofile/assets/vendors/swiper/swiper.min.css')}}" />
    <link rel="stylesheet" href="{{asset('companyprofile/assets/vendors/insur-icons/style.css')}}">
    <link rel="stylesheet" href="{{asset('companyprofile/assets/vendors/tiny-slider/tiny-slider.min.css')}}" />
    <link rel="stylesheet" href="{{asset('companyprofile/assets/vendors/reey-font/stylesheet.css')}}" />
    <link rel="stylesheet" href="{{asset('companyprofile/assets/vendors/owl-carousel/owl.carousel.min.css')}}" />
    <link rel="stylesheet" href="{{asset('companyprofile/assets/vendors/owl-carousel/owl.theme.default.min.css')}}" />
    <link rel="stylesheet" href="{{asset('companyprofile/assets/vendors/bxslider/jquery.bxslider.css')}}" />
    <link rel="stylesheet" href="{{asset('companyprofile/assets/vendors/bootstrap-select/css/bootstrap-select.min.css')}}" />
    <link rel="stylesheet" href="{{asset('companyprofile/assets/vendors/vegas/vegas.min.css')}}" />
    <link rel="stylesheet" href="{{asset('companyprofile/assets/vendors/jquery-ui/jquery-ui.css')}}}" />
    <link rel="stylesheet" href="{{asset('companyprofile/assets/vendors/timepicker/timePicker.css')}}" />
    <link rel="stylesheet" href="{{asset('companyprofile/assets/css/timeline.css')}}" />
    <!-- template styles -->
    <link rel="stylesheet" href="{{asset('companyprofile/assets/css/insur.css')}}" />
    <link rel="stylesheet" href="{{asset('companyprofile/assets/css/insur-responsive.css')}}" />
...
<body class="custom-cursor boxed-wrapper">
    ...
    <div class="page-wrapper">
                        ...
                        <div class="main-menu__wrapper-inner clearfix">
                            <div class="main-menu__left">
                                <div class="main-menu__logo">
                                    <a href="Index-Boxed.html"><img src="{{asset('companyprofile/assets/Photos/PRO1LOGO (2).png')}}" alt=""></a>
                                </div>
            ...
            <div class="swiper-container thm-swiper__slider" data-swiper-options='{"slidesPerView": 1, "loop": true,
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="image-layer-three" style="background-image: url({{asset('companyprofile/assets/Photos/Banner/Banner-1.jpg')}});"></div>
                        <!-- /.image-layer -->
                    ...
                    <div class="swiper-slide">
                        <div class="image-layer-three" style="background-image: url({{asset('companyprofile/assets/Photos/Banner/Banner-2.jpg')}});"></div>
                        <!-- /.image-layer -->
                    ...
                    <div class="swiper-slide">
                        <div class="image-layer-three" style="background-image: url({{asset('companyprofile/assets/Photos/Banner/Banner-3.jpg')}});"></div>
                        <!-- /.image-layer -->
                    ...
                    <div class="swiper-slide">
                        <div class="image-layer-three" style="background-image: url({{asset('companyprofile/assets/Photos/Banner/Banner-4.jpg')}});"></div>
                        <!-- /.image-layer -->
        ...
        <section class="we-provide">
            <div class="we-provide-bg" style="background-image: url({{asset('companyprofile/assets/images/backgrounds/we-provide-bg.jpg')}});">
            </div>
            <div class="container">
                                    ...
                                    <div class="tabs-content">
                                        ...
                                        <div class="tab" id="values">
                                            <div class="we-provide__tab-main-content-inner">
                                                <div class="we-provide-shape-1">
                                                    <img src="{{asset('companyprofile/assets/images/shapes/we-provide-shape-1.png')}}" alt="">
                                                </div>
                                                ...
                                                <div class="we-provide__tab-main-content-right">
                                                    <div class="we-provide__tab-main-content-right-img">
                                                        <img src="{{asset('companyprofile/assets/images/resources/we-provide-tab-main-content-right-img.jpg')}}" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab " id="mission">
                                            <div class="we-provide__tab-main-content-inner">
                                                ...
                                                <div class="we-provide__tab-main-content-right">
                                                    <div class="we-provide__tab-main-content-right-img">
                                                        <img src="{{asset('companyprofile/assets/Photos/mission1.png')}}" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab active-tab" id="goals">
                                            <div class="we-provide__tab-main-content-inner">
                                                ...
                                                <div class="we-provide__tab-main-content-right">
                                                    <div class="we-provide__tab-main-content-right-img">
                                                        <img src="{{asset('companyprofile/assets/Photos/vision1.png')}}" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
                        <div class="feature-two__single">
                            <div class="feature-two__img">
                                <img src="{{asset('companyprofile/assets/Photos/estab.png')}}" alt="">
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                        <div class="feature-two__single">
                            <div class="feature-two__img">
                                <img src="{{asset('companyprofile/assets/Photos/milestone-mission.png')}}" alt="">
                            </div>
                            <div class="feature-two__content">
                                <div class="feature-two__content-inner">
                                    <div class="feature-two__icon">
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
                        <div class="feature-two__single">
                            <div class="feature-two__img">
                                <img src="{{asset('companyprofile/assets/Photos/joint.png')}}" alt="">
                            </div>
                            <div class="feature-two__content">
                                <div class="feature-two__content-inner">
                                    <div class="feature-two__icon">
                        ...
                        <div class="about-two__middle">
                            <div class="about-two__img-box">
                                <div class="about-two__img">
                                    <img src="{{asset('companyprofile/assets/Photos/about.jpg')}}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="services-two">
            <div class="services-two-shape-1" style="background-image: url{{asset('companyprofile/assets/images/shapes/services-two-shape-1.png')}};"></div>
            <div class="container">
                            ...
                            <div class="services-two__top-left">
                                <div class="section-title text-left">
                                    <div class="section-sub-title-box">
                                        ...
                                        <div class="section-title-shape-1">
                                            <img src="{{asset('companyprofile/assets/images/shapes/section-title-shape-5.png')}}" alt="">
                                        </div>
                                        <div class="section-title-shape-2">
                                            <img src="{{asset('companyprofile/assets/images/shapes/section-title-shape-6.png')}}" alt="">
                                        </div>
                                    </div>
...
<rect id="_Transparent_Rectangle" style="fill:none;" width="32" height="32"/>
    ...
    <section class="about-one">
        <div class="about-one-bg wow slideInRight" data-wow-delay="100ms" data-wow-duration="2500ms" style="background-image: url{{asset('companyprofile/assets/Photos/gra.png')}};">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="about-one__img-box wow slideInLeft" data-wow-delay="100ms" data-wow-duration="2500ms">
                            <div class="about-one__img">
                                <a target="_blank" href="https://pro1globalhomecenter.com/home.html?divisionId=1&townshipId=18">
                                    <img src="{{asset('companyprofile/assets/Photos/e-commerceads5.png')}}" alt=""></a>
                            </div>
    ...
    <section class="download">
        <div class="download-bg" style="background-image: url{{asset('companyprofile/assets/images/shapes/services-two-shape-1.png')}};"></div>
        <div class="download-shape-1 float-bob-y">
            <img src="{{asset('companyprofile/assets/images/shapes/download-shape-1.png')}}" alt="">
        </div>
        <div class="download-shape-2 float-bob-x">
            <img src="{{asset('companyprofile/assets/images/shapes/download-shape-2.png')}}" alt="">
        </div>
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-5 col-lg-6">
                    <div class="download__right">
                        <div class="download__img wow slideInRight" data-wow-delay="100ms" data-wow-duration="2500ms">
                            <img src="{{asset('companyprofile/assets/Photos/ecommerceapp.png')}}" alt="">
                ...
                <div class="row">
                        ...
                        <div class="services-one__single">
                            <a href="ProductInformation.html">
                                <div class="service-one__img">
                                    <img src="{{asset('companyprofile/assets/Photos/Only Icon/Product Information.png')}}" alt="">
                                </div>
                            </a>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                        <a href="DeliveryService.html">
                            <div class="services-one__single">
                                <div class="service-one__img">
                                    <img src="{{asset('companyprofile/assets/Photos/Only Icon/Delivery Service.png')}}" alt="">
                                </div>
                                <div class="service-one__content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                        <a href="SpecialOrder.html">
                            <div class="services-one__single">
                                <div class="service-one__img">
                                    <img src="{{asset('companyprofile/assets/Photos/Only Icon/Special Order.png')}}" alt="">
                                </div>
                                <div class="service-one__content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                        <a href="ProductReturn.html">
                            <div class="services-one__single">
                                <div class="service-one__img">
                                    <img src="{{asset('companyprofile/assets/Photos/Only Icon/Product Return.png')}}" alt="">
                                </div>
                                <div class="service-one__content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="500ms">
                        <a href="ConsultingService.html">
                            <div class="services-one__single">
                                <div class="service-one__img">
                                    <img src="{{asset('companyprofile/assets/Photos/Only Icon/Consulting Service.png')}}" alt="">
                                </div>
                                <div class="service-one__content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="600ms">
                        <a href="ContractorInformation.html">
                            <div class="services-one__single">
                                <div class="service-one__img">
                                    <img src="{{asset('companyprofile/assets/Photos/Only Icon/Contractor Information.png')}}" alt="">
                                </div>
                                <div class="service-one__content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="700ms">
                        <a href="MemberService.html">
                            <div class="services-one__single">
                                <div class="service-one__img">
                                    <img src="{{asset('companyprofile/assets/Photos/Only Icon/Member Service.png')}}" alt="">
                                </div>
                                <div class="service-one__content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="800ms">
                        <a href="RepairService.html">
                            <div class="services-one__single">
                                <div class="service-one__img">
                                    <img src="{{asset('companyprofile/assets/Photos/Only Icon/Power Tools Repair Service_2.png')}}" alt="">
                                </div>
                                <div class="service-one__content">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-5 col-lg-6">
                    <div class="download__right">
                        <div class="download__img wow slideInRight" data-wow-delay="100ms" data-wow-duration="2500ms">
                            <img src="{{asset('companyprofile/assets/Photos/memberapp.png')}}" alt="">
                            <div class="download__badge">
        ...
        <div class="container">
            ...
            <div class="row filter-layout masonary-layout mt-3">
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra busi insur">
                    <div class="portfolio__single">
                        <div class="portfolio__img">
                            <img src="{{asset('companyprofile/assets/Photos/lanthit.png')}}" alt="">
                            <div class="portfolio__plus">
                                <a href="{{asset('companyprofile/assets/Photos/lanthit.png')}}" class="img-popup"><span class="icon-plus"></span></a>
                            </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra busi insur">
                    <div class="portfolio__single">
                        <div class="portfolio__img">
                            <img src="{{asset('companyprofile/assets/Photos/satsan.png')}}" alt="">
                            <div class="portfolio__plus">
                                <a href="{{asset('companyprofile/assets/Photos/satsan.png')}}" class="img-popup"><span class="icon-plus"></span></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra busi poli">
                    <div class="portfolio__single">
                        <div class="portfolio__img">
                            <img src="{{asset('companyprofile/assets/Photos/eastdagon.png')}}" alt="">
                            <div class="portfolio__plus">
                                <a href="{{asset('companyprofile/assets/Photos/eastdagon.png')}}" class="img-popup"><span class="icon-plus"></span></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra busi poli">
                    <div class="portfolio__single">
                        <div class="portfolio__img">
                            <img src="{{asset('companyprofile/assets/Photos/hlaingtharyar.png')}}" alt="">
                            <div class="portfolio__plus">
                                <a href="{{asset('companyprofile/assets/Photos/hlaingtharyar.png')}}" class="img-popup"><span class="icon-plus"></span></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra busi poli">
                    <div class="portfolio__single">
                        <div class="portfolio__img">
                            <img src="{{asset('companyprofile/assets/Photos/terminal.jpg')}}" alt="">
                            <div class="portfolio__plus">
                                <a href="{{asset('companyprofile/assets/Photos/terminal.jpg')}}" class="img-popup"><span class="icon-plus"></span></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra busi poli">
                    <div class="portfolio__single">
                        <div class="portfolio__img">
                            <img src="{{asset('companyprofile/assets/Photos/southdagon.jpg')}}" alt="">
                            <div class="portfolio__plus">
                                <a href="{{asset('companyprofile/assets/Photos/southdagon.jpg')}}" class="img-popup"><span class="icon-plus"></span></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra busi poli">
                    <div class="portfolio__single">
                        <div class="portfolio__img">
                            <img src="{{asset('companyprofile/assets/Photos/shwepyithar.jpg')}}" alt="">
                            <div class="portfolio__plus">
                                <a href="{{asset('companyprofile/assets/Photos/shwepyithar.jpg')}}" class="img-popup"><span class="icon-plus"></span></a>
                            </div>
                            <div class="portfolio__content">
    ...
    <section class="ourcenter mt-5" id="ourCenter">
        <div class="container">
            ...
            <div class="row filter-layout masonary-layout mt-3">
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra busi insur">
                    <div class="portfolio__img">
                        <img src="{{asset('companyprofile/assets/Photos/theikpan.png')}}" alt="">
                        <div class="portfolio__plus">
                            <a href="{{asset('companyprofile/assets/Photos/theikpan.png')}}" class="img-popup"><span class="icon-plus"></span></a>
                        </div>
                        <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra busi insur">
                    <div class="portfolio__single">
                        <div class="portfolio__img">
                            <img src="{{asset('companyprofile/assets/Photos/tampawady.png')}}" alt="">
                            <div class="portfolio__plus">
                                <a href="{{asset('companyprofile/assets/Photos/tampawady.png')}}" class="img-popup"><span class="icon-plus"></span></a>
                            </div>
                            <div class="portfolio__content">
                    ...
                    <div class="container">
                        ...
                        <div class="row filter-layout masonary-layout mt-3">
                            <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra busi insur">
                                <div class="portfolio__single">
                                    <div class="portfolio__img">
                                        <img src="{{asset('companyprofile/assets/Photos/bago.jpg')}}" alt="">
                                        <div class="portfolio__plus">
                                            <a href="{{asset('companyprofile/assets/Photos/bago.jpg')}}" class="img-popup"><span class="icon-plus"></span></a>
                                        </div>
                                        <div class="portfolio__content">
                        ...
                        <div class="owl-carousel owl-theme thm-owl__carousel testimonial-one__carousel" data-owl-options='{
                                    ...
                                    <div class="testimonial-one__single-inner">
                                        ...
                                        <div class="testimonial-one__client-info">
                                            <a target="_blank" href="https://pro1globalhomecenter.com/product-list.html?divisionId=2&townshipId=1&sortBy=1&searchText=BCC">
                                                <div class=>
                                                    <img src="{{asset('companyprofile/assets/Photos/Brands/B1.png')}}" alt=""></a>
                                        ...
                                        <div class="testimonial-one__client-info">
                                            <div class=>
                                                <a target="_blank" href="https://pro1globalhomecenter.com/product-list.html?divisionId=1&townshipId=18&sortBy=1&searchText=OPPLE">
                                                    <img src="{{asset('companyprofile/assets/Photos/Brands/B2.png')}}" alt=""></a>
                                                <!-- <div class="testimonial-one__quote">
                                                    <img src="companyprofile/assets/images/testimonial/testimonial-1-quote.png" alt="">
                                                </div> -->
                                            </div>
                            ...
                            <div class="item">
                                <div class="testimonial-one__single">
                                    <div class="testimonial-one__single-inner">
                                        <div class="testimonial-one__shape-1">
                                            <img src="{{asset('companyprofile/assets/images/shapes/testimonial-one-shape-1.png')}}" alt="">
                                        </div>
                                        <div class="partaner mb-5">
                                        ...
                                        <div class="testimonial-one__client-info">
                                            <div class=>
                                                <a target="_blank" href="https://pro1globalhomecenter.com/product-list.html?divisionId=1&townshipId=18&brandId=49">
                                                    <img src="{{asset('companyprofile/assets/Photos/Brands/B3.png')}}" alt=""></a>
                                                <!-- <div class="testimonial-one__quote">
                                                    <img src="companyprofile/assets/images/testimonial/testimonial-1-quote.png" alt="">
                                                </div> -->
                                            </div>
                                        ...
                                        <div class="testimonial-one__client-info">
                                            <div class=>
                                                <a target="_blank" href="https://pro1globalhomecenter.com/product-list.html?divisionId=1&townshipId=18&brandId=82">
                                                    <img src="{{asset('companyprofile/assets/Photos/Brands/B5.png')}}" alt=""></a>
                                                <!-- <div class="testimonial-one__quote">
                                                    <img src="companyprofile/assets/images/testimonial/testimonial-1-quote.png" alt="">
                                                </div> -->
                                            </div>
                                        ...
                                        <div class="testimonial-one__client-info">
                                            <div class=>
                                                <a target="_blank" href="https://pro1globalhomecenter.com/product-list.html?divisionId=1&townshipId=18&brandId=81">
                                                    <img src="{{asset('companyprofile/assets/Photos/Brands/B6.png')}}" alt=""></a>
                                                <!-- <div class="testimonial-one__quote">
                                                    <img src="companyprofile/assets/images/testimonial/testimonial-1-quote.png" alt="">
                                                </div> -->
                                            </div>
                                        ...
                                        <div class="testimonial-one__client-info">
                                            <div class=>
                                                <a target="_blank" href="https://pro1globalhomecenter.com/product-list.html?divisionId=1&townshipId=18&brandId=87">
                                                    <img src="{{asset('companyprofile/assets/Photos/Brands/B7.jpg')}}" alt=""></a>
                                            </div>
                                            <div class="testimonial-one__client-content">
        ...
        <div class="container">
            ...
            <div class="row filter-layout masonary-layout">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item busi custom-img">
                    <div class="portfolio__single">
                        <div class="">
                            <img src="{{asset('companyprofile/assets/Photos/act1.png')}}" alt="">
                            <div class="">
                                <a href="{{asset('companyprofile/assets/Photos/act1.png')}}" class="img-popup"></a>
                            </div>
                            <div>
                                <ul class="list-unstyled about-one__points">
                                <li>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item busi custom-img">
                    <div class="portfolio__single">
                        <div class="">
                            <img src="{{asset('companyprofile/assets/Photos/act2.png')}}" alt="">
                            <div class="">
                                <a href="{{asset('companyprofile/assets/Photos/act2.png')}}" class="img-popup"><span class=""></span></a>
                            </div>
                            <div>
                               <ul class="list-unstyled about-one__points">
                                <li>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item busi custom-img">
                    <div class="portfolio__single">
                        <div class="">
                            <img src="{{asset('companyprofile/assets/Photos/act3.png')}}" alt="">
                            <div class="">
                                <a href="{{asset('companyprofile/assets/Photos/act3.png')}}" class="img-popup"><span class=""></span></a>
                            </div>
                            <div>
                                <ul class="list-unstyled about-one__points">
                                <li>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item busi custom-img">
                    <div class="portfolio__single">
                        <div class="">
                            <img src="{{asset('companyprofile/assets/Photos/act4.png')}}" alt="">
                            <div class="">
                                <a href="{{asset('companyprofile/assets/Photos/act4.png')}}" class="img-popup"><span class=""></span></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item busi custom-img">
                    <div class="portfolio__single">
                        <div class="">
                            <img src="{{asset('companyprofile/assets/Photos/act5.png')}}" alt="">
                            <div class="">
                                <a href="{{asset('companyprofile/assets/Photos/act5.png')}}" class="img-popup"><span class=""></span></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item busi custom-img">
                    <div class="portfolio__single">
                        <div class="">
                            <img src="{{asset('companyprofile/assets/Photos/act6.png')}}" alt="">
                            <div class="">
                                <a href="{{asset('companyprofile/assets/Photos/act6.png')}}" class="img-popup"><span class=""></span></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra custom-img">
                    <div class="portfolio__single">
                        <div class="portfolio__img">
                            <img src="{{asset('companyprofile/assets/Photos/training1.pn')}}g" alt="">
                            <div class="">
                                <a href="{{asset('companyprofile/assets/Photos/training1.png')}}" class="img-popup"><span class=""></span></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra custom-img">
                    <div class="portfolio__single">
                        <div class="portfolio__img">
                            <img src="{{asset('companyprofile/assets/Photos/training2.png')}}" alt="">
                            <div class="">
                                <a href="{{asset('companyprofile/assets/Photos/training2.png')}}" class="img-popup"><span class=""></span></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra custom-img">
                    <div class="portfolio__single">
                        <div class="portfolio__img">
                            <img src="{{asset('companyprofile/assets/Photos/training3.png')}}" alt="">
                            <div class="">
                                <a href="{{asset('companyprofile/assets/Photos/training3.png')}}" class="img-popup"><span class=""></span></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra custom-img">
                    <div class="portfolio__single">
                        <div class="">
                            <img src="{{asset('companyprofile/assets/Photos/act17.png')}}" alt="">
                            <div class="">
                                <a href="{{asset('companyprofile/assets/Photos/act17.png')}}" class="img-popup"><span class=""></span></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra custom-img">
                    <div class="portfolio__single">
                        <div class="">
                            <img src="{{asset('companyprofile/assets/Photos/act10.png')}}" alt="">
                            <div class="">
                                <a href="{{asset('companyprofile/assets/Photos/act10.png')}}" class="img-popup"><span class=""></span></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra custom-img">
                    <div class="portfolio__single">
                        <div class="">
                            <img src="{{asset('companyprofile/assets/Photos/act18.png')}}" alt="">
                            <div class="">
                                <a href="{{asset('companyprofile/assets/Photos/act18.png')}}" class="img-popup"><span class=""></span></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra custom-img">
                    <div class="portfolio__single">
                        <div class="">
                            <img src="{{asset('companyprofile/assets/Photos/act13.png')}}" alt="">
                            <div class="">
                                <a href="{{asset('companyprofile/assets/Photos/act13.png')}}" class="img-popup"><span class=""></span></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra custom-img">
                    <div class="portfolio__single">
                        <div class="">
                            <img src="{{asset('companyprofile/assets/Photos/act12.png')}}" alt="">
                            <div class="">
                                <a href="{{asset('companyprofile/assets/Photos/act12.png')}}" class="img-popup"><span class=""></span></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra custom-img">
                    <div class="portfolio__single">
                        <div class="">
                            <img src="{{asset('companyprofile/assets/Photos/act11.png')}}" alt="">
                            <div class="">
                                <a href="{{asset('companyprofile/assets/Photos/act11.png')}}" class="img-popup"><span class=""></span></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra custom-img">
                    <div class="portfolio__single">
                        <div class="">
                            <img src="{{asset('companyprofile/assets/Photos/act16.png')}}" alt="">
                            <div class="">
                                <a href="{{asset('companyprofile/assets/Photos/act16.png')}}" class="img-popup"><span class=""></span></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra custom-img">
                    <div class="portfolio__single">
                        <div class="">
                            <img src="{{asset('companyprofile/assets/Photos/act14.png')}}" alt="">
                            <div class="">
                                <a href="{{asset('companyprofile/assets/Photos/act14.png')}}" class="img-popup"><span class=""></span></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra custom-img">
                    <div class="portfolio__single">
                        <div class="">
                            <img src="{{asset('companyprofile/assets/Photos/act15.png')}}" alt="">
                            <div class="">
                                <a href="{{asset('companyprofile/assets/Photos/act15.png')}}" class="img-popup"><span class=""></span></a>
                            </div>
                            <div class="portfolio__content">
    ...
    <div class="page-wrapper">
                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="contact-page__right">
                            <div class="contact-page__form">
                                <form action="{{asset('companyprofile/assets/inc/sendemail.php')}}" class="comment-one__form contact-form-validated"
        ...
        <div class="site-footer-bg " style="background-image: url{{asset('companyprofile/assets/images/backgrounds/site-footer-bg.png')}}; ">
        </div>
        <div class="container ">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp " data-wow-delay="100ms ">
                        <div class="footer-widget__column footer-widget__about ">
                            <div class="footer-widget__logo ">
                                <a href="Index-Boxed.html"><img src="{{asset('companyprofile/assets/Photos/footerlogo.png')}} " alt=" " width="200px " height="70px "></a>
                            </div>
                            ...
                            <ul class="footer-widget__gallery-list list-unstyled clearfix ">
                                <li class="col-md-4 ">
                                    ...
                                    <div class="footer-widget__gallery-img ">
                                        ...
                                        <img src="{{asset('companyprofile/assets/Photos/sc-fb8.png')}} " alt=" ">
                                ...
                                <li class="col-md-4 ">
                                    <div class="footer-widget__gallery-img ">
                                        <img src="{{asset('companyprofile/assets/Photos/sc-vb6.png')}} " alt=" ">
                                ...
                                <li class="col-md-4 ">
                                    <div class="footer-widget__gallery-img ">
                                        <img src="{{asset('companyprofile/assets/Photos/sc-yt1.png ')}}" alt=" ">
                                        <a target="_blank" href="https://www.youtube.com/channel/UCvTMpi4etgXlCdnIEMkO8Ig "><span class="fa fa-link "></span></a>
                                    </div>
                                </li>
                                <li class="col-md-4 ">
                                    <div class="footer-widget__gallery-img ">
                                        <img src="{{asset('companyprofile/assets/Photos/sc-yt3.png')}} " alt=" ">
    ...
    <div class="mobile-nav__wrapper ">
        ...
        <div class="mobile-nav__content ">
            ...
            <div class="logo-box ">
                <a href="index.html " aria-label="logo image "><img src="{{asset('companyprofile/assets/Photos/PRO1LOGO (2).png ')}}" width="143 " alt=" " /></a>
            </div>
    ...
    <script src="{{asset('companyprofile/assets/vendors/jquery/jquery-3.6.0.min.js ')}}"></script>
    <script src="{{asset('companyprofile/assets/vendors/bootstrap/js/bootstrap.bundle.min.js')}} "></script>
    <script src="{{asset('companyprofile/assets/vendors/jarallax/jarallax.min.js ')}}"></script>
    <script src="{{asset('companyprofile/assets/vendors/jquery-ajaxchimp/jquery.ajaxchimp.min.js')}} "></script>
    <script src="{{asset('companyprofile/assets/vendors/jquery-appear/jquery.appear.min.js ')}}"></script>
    <script src="{{asset('companyprofile/assets/vendors/jquery-circle-progress/jquery.circle-progress.min.js ')}}"></script>
    <script src="{{asset('companyprofile/assets/vendors/jquery-magnific-popup/jquery.magnific-popup.min.js ')}}"></script>
    <script src="{{asset('companyprofile/assets/vendors/jquery-validate/jquery.validate.min.js')}} "></script>
    <script src="{{asset('companyprofile/assets/vendors/nouislider/nouislider.min.js ')}}"></script>
    <script src="{{asset('companyprofile/assets/vendors/odometer/odometer.min.js ')}}"></script>
    <script src="{{asset('companyprofile/assets/vendors/swiper/swiper.min.js ')}}"></script>
    <script src="{{asset('companyprofile/assets/vendors/tiny-slider/tiny-slider.min.js ')}}"></script>
    <script src="{{asset('companyprofile/assets/vendors/wnumb/wNumb.min.js ')}}"></script>
    <script src="{{asset('companyprofile/assets/vendors/wow/wow.js')}} "></script>
    <script src="{{asset('companyprofile/assets/vendors/isotope/isotope.js ')}}"></script>
    <script src="{{asset('companyprofile/assets/vendors/countdown/countdown.min.js')}} "></script>
    <script src="{{asset('companyprofile/assets/vendors/owl-carousel/owl.carousel.min.js')}} "></script>
    <script src="{{asset('companyprofile/assets/vendors/bxslider/jquery.bxslider.min.js ')}}"></script>
    <script src="{{asset('companyprofile/assets/vendors/bootstrap-select/js/bootstrap-select.min.js ')}}"></script>
    <script src="{{asset('companyprofile/assets/vendors/vegas/vegas.min.js ')}}"></script>
    <script src="{{asset('companyprofile/assets/vendors/jquery-ui/jquery-ui.js ')}}"></script>
    <script src="{{asset('companyprofile/assets/vendors/timepicker/timePicker.js ')}}"></script>
    <script src="{{asset('companyprofile/assets/vendors/circleType/jquery.circleType.js ')}}"></script>
    <script src="{{asset('companyprofile/assets/vendors/circleType/jquery.lettering.min.js ')}}"></script>

    <!-- template js -->
    <script src="{{asset('companyprofile/assets/js/insur.js')}} "></script>
</body>
