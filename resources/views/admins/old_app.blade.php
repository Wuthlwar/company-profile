  ...
  <body>
    <div class="sidebar sidebar-dark sidebar-fixed" id="sidebar">
      ...
      <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
        ...
        <li class="nav-item"><a class="nav-link" href="{{ route('activities.index') }}">
            <svg class="nav-icon">
        ...
        <img src="{{ asset('assets/photos/pro_1.png') }}" width="118" height="46" alt="">
          ...
          <ul class="header-nav ms-3">
            <li class="nav-item dropdown"><a class="nav-link py-0" data-coreui-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                <div class="avatar avatar-md"><img class="avatar-img" src="{{ asset('admin/dist/assets/img/avatars/8.jpg') }}" alt="user@email.com"></div>
              </a>
              <div class="dropdown-menu dropdown-menu-end pt-0">
                ...
                <div class="dropdown-header bg-light py-2">
                  ...
                  <svg class="icon me-2">
                    <use xlink:href="{{ asset('admin/dist/vendors/@coreui/icons/svg/free.svg#cil-user') }}"></use>
