                        ...
                        <ul class="list-unstyled main-header__top-menu">
                            <li>
                                <div class="languagebox">
                                    ...
                                    <?php switch($locale):
                                        case ('en'): ?>
                                            <a class="iq-sub-card" href="<?php echo e(route('lang','mm')); ?>">
                                                Eng
                                            </a>
                                        <?php break; ?>
                                        <?php case ('mm'): ?>
                                        <a class="iq-sub-card" href="<?php echo e(route('lang','en')); ?>">
                                            Myan
                                        </a>
                                        <?php break; ?>
                                        <?php default: ?>
                ...
                <div class="main-menu__wrapper-inner clearfix">
                    <div class="main-menu__left">
                        <div class="main-menu__logo">
                            <a href="index.html"><img src="<?php echo e(asset('assets/photos/pro1global_logo_blank.png')); ?>" alt=""></a>
                        </div>
                            ...
                            <div class="main-menu__main-menu-box-inner">
                                ...
                                <ul class="main-menu__list">
                                    ...
                                    <li class="dropdown current ">
                                        <a href="<?php echo e(route('home')); ?>#ourServices">Our Services</a>

                                    </li>
                                    <li class="dropdown ">
                                        <a href="<?php echo e(route('home')); ?>#ourCenter"><?php echo e(__('our_center.our_center')); ?></a>

                                    </li>
                                    <li class="dropdown">
                                        <a href="<?php echo e(route('home')); ?>#ourPatner">Our Partners</a>

                                    </li>
                                    <li class="dropdown">
                                        <a href="<?php echo e(route('home')); ?>#ouractivities">Our Activities</a>
...
<?php /**PATH /home/vagrant/code/current_projects/company-profile/resources/views/layouts/header.blade.php ENDPATH**/ ?>