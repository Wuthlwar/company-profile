            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="portfolio-details__img">
                        <img src="<?php echo e(asset('assets/photos/joint1.jpg')); ?>" alt="">
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="portfolio-details__content-right">
                            <div class="portfolio-details__details-box">
                                ...
                                <a href=""><img src="<?php echo e(asset('assets/photos/pro1.png')); ?>" alt=""></a>
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="portfolio-details__content-right">
                            <div class="portfolio-details__details-box">
                                ...
                                <a href=""><img src="<?php echo e(asset('assets/photos/scg2.png')); ?>" alt=""></a>
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="portfolio-details__content-right">
                            <div class="portfolio-details__details-box">
                                ...
                                <a href=""><img src="<?php echo e(asset('assets/photos/gb1.png')); ?>" alt=""></a>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\company-profile\resources\views/joint_venture.blade.php ENDPATH**/ ?>