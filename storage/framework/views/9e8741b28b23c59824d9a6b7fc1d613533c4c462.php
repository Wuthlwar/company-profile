...
<head>
    ...
    <!-- favicons Icons -->
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo e(asset('companyprofile/assets/images/favicons/apple-touch-icon.png')); ?>" />
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo e(asset('companyprofile/assets/Photos/PRO1LOGO (2).png')); ?>" />
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo e(asset('companyprofile/assets/Photos/PRO1LOGO (2).png')); ?>" />
    <link rel="manifest" href="<?php echo e(asset('companyprofile/assets/images/favicons/site.webmanifest')); ?>" />
    <meta name="description" content="Insur HTML 5 Template " />
    <script src="https://kit.fontawesome.com/e540fbdad6.js" crossorigin="anonymous"></script>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('companyprofile/assets/vendors/bootstrap/css/bootstrap.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('companyprofile/assets/vendors/animate/animate.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('companyprofile/assets/vendors/animate/custom-animate.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('companyprofile/assets/vendors/fontawesome/css/all.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('companyprofile/assets/vendors/jarallax/jarallax.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('companyprofile/assets/vendors/jquery-magnific-popup/jquery.magnific-popup.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('companyprofile/assets/vendors/jquery-magnific-popup/jquery.magnific-popup.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('companyprofile/assets/vendors/nouislider/nouislider.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('companyprofile/assets/vendors/nouislider/nouislider.pips.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('companyprofile/assets/vendors/odometer/odometer.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('companyprofile/assets/vendors/swiper/swiper.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('companyprofile/assets/vendors/insur-icons/style.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('companyprofile/assets/vendors/tiny-slider/tiny-slider.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('companyprofile/assets/vendors/reey-font/stylesheet.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('companyprofile/assets/vendors/owl-carousel/owl.carousel.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('companyprofile/assets/vendors/owl-carousel/owl.theme.default.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('companyprofile/assets/vendors/bxslider/jquery.bxslider.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('companyprofile/assets/vendors/bootstrap-select/css/bootstrap-select.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('companyprofile/assets/vendors/vegas/vegas.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('companyprofile/assets/vendors/jquery-ui/jquery-ui.css')); ?>}" />
    <link rel="stylesheet" href="<?php echo e(asset('companyprofile/assets/vendors/timepicker/timePicker.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('companyprofile/assets/css/timeline.css')); ?>" />
    <!-- template styles -->
    <link rel="stylesheet" href="<?php echo e(asset('companyprofile/assets/css/insur.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('companyprofile/assets/css/insur-responsive.css')); ?>" />
...
<body class="custom-cursor boxed-wrapper">
    ...
    <div class="page-wrapper">
                        ...
                        <div class="main-header__top-right">
                            ...
                            <div class="main-header__top-social-box">
                                <div class="main-header__top-social">
                                    ...
                                    <a target="_blank" href="https://www.youtube.com/channel/UCvTMpi4etgXlCdnIEMkO8Ig"><i class="fa fa-youtube" aria-hidden="true"></i></a>
                        ...
                        <div class="main-menu__wrapper-inner clearfix">
                            <div class="main-menu__left">
                                <div class="main-menu__logo">
                                    <a href="Index-Boxed.html"><img src="<?php echo e(asset('companyprofile/assets/Photos/PRO1LOGO (2).png')); ?>" alt=""></a>
                                </div>
                                <div class="main-menu__main-menu-box">
                                    <div class="main-menu__main-menu-box-inner">
                                        ...
                                        <ul class="main-menu__list">
                                            ...
                                            <li class="dropdown ">
                                                <a href="#ourCenter">Our Centers</a>

                                            </li>
                                            <li class="dropdown">
                                                <a href="#ourPatner">Our Patners</a>
            ...
            <div class="swiper-container thm-swiper__slider" data-swiper-options='{"slidesPerView": 1, "loop": true,
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="image-layer-three" style="background-image: url(<?php echo e(asset('companyprofile/assets/Photos/Banner/Banner-1.jpg')); ?>);"></div>
                        <!-- /.image-layer -->
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="main-slider-three__content">
                                        <h2 class="main-slider-three__title">PRO 1 Global<br> Home Center</h2>
                                        <p class="main-slider-three__text">PRO 1 Global Home Center is the first and largest company<br> selling home building products in Myanmar.</p>
                                        <div class="main-slider-three__btn-box">
                                            <a target="_blank" href="https://pro1globalhomecenter.com/home.html?divisionId=1&townshipId=18" class="thm-btn main-slider-three__btn">"Buy Now"</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="image-layer-three" style="background-image: url(<?php echo e(asset('companyprofile/assets/Photos/Banner/Banner-2.jpg')); ?>);"></div>
                        <!-- /.image-layer -->

                        <div class="container">
                            <div class="row">
                                <a href="https://pro1globalhomecenter.com/under-maintenance.html"></a>
                                <div class="col-xl-12">
                                    <div class="main-slider-three__content">
                                        <h2 class="main-slider-three__title">PRO 1 Global<br> Home Center</h2>
                                        <p class="main-slider-three__text">PRO 1 Global Home Center is the first and largest company<br> selling home building products in Myanmar.</p>
                    ...
                    <div class="swiper-slide">
                        <div class="image-layer-three" style="background-image: url(<?php echo e(asset('companyprofile/assets/Photos/Banner/Banner-3.jpg')); ?>);"></div>
                        <!-- /.image-layer -->
                    ...
                    <div class="swiper-slide">
                        <div class="image-layer-three" style="background-image: url(<?php echo e(asset('companyprofile/assets/Photos/Banner/Banner-4.jpg')); ?>);"></div>
                        <!-- /.image-layer -->
        ...
        <section class="we-provide">
            <div class="we-provide-bg" style="background-image: url(<?php echo e(asset('companyprofile/assets/images/backgrounds/we-provide-bg.jpg')); ?>);">
            </div>
            <div class="container">
                <div class="section-title text-left">
                    <div class="section-sub-title-box">
                        <p class="section-sub-title">Company Vission & Mission</p>
                                    ...
                                    <div class="tabs-content">
                                        ...
                                        <div class="tab" id="values">
                                            <div class="we-provide__tab-main-content-inner">
                                                <div class="we-provide-shape-1">
                                                    <img src="<?php echo e(asset('companyprofile/assets/images/shapes/we-provide-shape-1.png')); ?>" alt="">
                                                </div>
                                                ...
                                                <div class="we-provide__tab-main-content-right">
                                                    <div class="we-provide__tab-main-content-right-img">
                                                        <img src="<?php echo e(asset('companyprofile/assets/images/resources/we-provide-tab-main-content-right-img.jpg')); ?>" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab " id="mission">
                                            <div class="we-provide__tab-main-content-inner">
                                                ...
                                                <div class="we-provide__tab-main-content-right">
                                                    <div class="we-provide__tab-main-content-right-img">
                                                        <img src="<?php echo e(asset('companyprofile/assets/Photos/mission1.png')); ?>" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab active-tab" id="goals">
                                            <div class="we-provide__tab-main-content-inner">
                                                ...
                                                <div class="we-provide__tab-main-content-right">
                                                    <div class="we-provide__tab-main-content-right-img">
                                                        <img src="<?php echo e(asset('companyprofile/assets/Photos/vision1.png')); ?>" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
                        <div class="feature-two__single">
                            <div class="feature-two__img">
                                <img src="<?php echo e(asset('companyprofile/assets/Photos/estab.png')); ?>" alt="">
                            </div>
                            <div class="feature-two__content">
                                <div class="feature-two__content-inner">
                                    ...
                                    <div class="feature-two__text-box">
                                        <p class="feature-two__text"><a href="EstablishYear.html">Establish
                                            <br>Year</a>
                                        </p>
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                        <div class="feature-two__single">
                            <div class="feature-two__img">
                                <img src="<?php echo e(asset('companyprofile/assets/Photos/milestone-mission.png')); ?>" alt="">
                            </div>
                            <div class="feature-two__content">
                                <div class="feature-two__content-inner">
                                    <div class="feature-two__icon">
                                    ...
                                    <div class="feature-two__text-box">
                                        <p class="feature-two__text"><a href="MileStone.html">Mile <br>
                                                Stone</a></p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
                        <div class="feature-two__single">
                            <div class="feature-two__img">
                                <img src="<?php echo e(asset('companyprofile/assets/Photos/joint.png')); ?>" alt="">
                            </div>
                            <div class="feature-two__content">
                                <div class="feature-two__content-inner">
                                    <div class="feature-two__icon">
                                    ...
                                    <div class="feature-two__text-box">
                                        <p class="feature-two__text"><a href="joint.html">Joint<br>
                                                Venture</a></p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="about-two__middle">
                            <div class="about-two__img-box">
                                <div class="about-two__img">
                                    <img src="<?php echo e(asset('companyprofile/assets/Photos/about.jpg')); ?>" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="services-two">
            <div class="services-two-shape-1" style="background-image: url<?php echo e(asset('companyprofile/assets/images/shapes/services-two-shape-1.png')); ?>;"></div>
            <div class="container">
                            ...
                            <div class="services-two__top-left">
                                <div class="section-title text-left">
                                    <div class="section-sub-title-box">
                                        ...
                                        <div class="section-title-shape-1">
                                            <img src="<?php echo e(asset('companyprofile/assets/images/shapes/section-title-shape-5.png')); ?>" alt="">
                                        </div>
                                        <div class="section-title-shape-2">
                                            <img src="<?php echo e(asset('companyprofile/assets/images/shapes/section-title-shape-6.png')); ?>" alt="">
                                        </div>
                                    </div>
...
<rect id="_Transparent_Rectangle" style="fill:none;" width="32" height="32"/>
    ...
    <section class="about-one">
        <div class="about-one-bg wow slideInRight" data-wow-delay="100ms" data-wow-duration="2500ms" style="background-image: url<?php echo e(asset('companyprofile/assets/Photos/gra.png')); ?>;">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="about-one__img-box wow slideInLeft" data-wow-delay="100ms" data-wow-duration="2500ms">
                            <div class="about-one__img">
                                <a target="_blank" href="https://pro1globalhomecenter.com/home.html?divisionId=1&townshipId=18">
                                    <img src="<?php echo e(asset('companyprofile/assets/Photos/e-commerceads5.png')); ?>" alt=""></a>
                            </div>
                            <!-- <div class="about-one__img-two">
                                <img src="companyprofile/assets/Photos/secbanner5.png" alt="">
                            </div> -->
                            <a target="_blank" href="https://pro1globalhomecenter.com/home.html?divisionId=1&townshipId=18">
    ...
    <section class="download">
        <div class="download-bg" style="background-image: url<?php echo e(asset('companyprofile/assets/images/shapes/services-two-shape-1.png')); ?>;"></div>
        <div class="download-shape-1 float-bob-y">
            <img src="<?php echo e(asset('companyprofile/assets/images/shapes/download-shape-1.png')); ?>" alt="">
        </div>
        <div class="download-shape-2 float-bob-x">
            <img src="<?php echo e(asset('companyprofile/assets/images/shapes/download-shape-2.png')); ?>" alt="">
        </div>
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-5 col-lg-6">
                    <div class="download__right">
                        <div class="download__img wow slideInRight" data-wow-delay="100ms" data-wow-duration="2500ms">
                            <img src="<?php echo e(asset('companyprofile/assets/Photos/ecommerceapp.png')); ?>" alt="">
                            <div class="download__badge">
                                <!-- <img src="companyprofile/assets/images/shapes/download-dadge.png" alt=""> -->
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="services-one__bottom">
            <div class="services-one__container">
                <div class="row">
                        ...
                        <div class="services-one__single">
                            <a href="ProductInformation.html">
                                <div class="service-one__img">
                                    <img src="<?php echo e(asset('companyprofile/assets/Photos/Only Icon/Product Information.png')); ?>" alt="">
                                </div>
                            </a>
                            <div class="service-one__content">
                                <h2 class="service-one__title"><a href="ProductInformation.html">-See More-</a></h2>
                    ...
                    <!--Services One Single Start-->
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                        <a href="DeliveryService.html">
                            <div class="services-one__single">
                                <div class="service-one__img">
                                    <img src="<?php echo e(asset('companyprofile/assets/Photos/Only Icon/Delivery Service.png')); ?>" alt="">
                                </div>
                                <div class="service-one__content">

                                    <h2 class="service-one__title"><a href="DeliveryService.html">-See More-</a></h2>
                    ...
                    <!--Services One Single Start-->
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                        <a href="SpecialOrder.html">
                            <div class="services-one__single">
                                <div class="service-one__img">
                                    <img src="<?php echo e(asset('companyprofile/assets/Photos/Only Icon/Special Order.png')); ?>" alt="">
                                </div>
                                <div class="service-one__content">

                                    <h2 class="service-one__title"><a href="SpecialOrder.html">-See More-</a></h2>
                                    <h5>"Special Order"</h5>
                                    </h2>
                    ...
                    <!--Services One Single Start-->
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                        <a href="ProductReturn.html">
                            <div class="services-one__single">
                                <div class="service-one__img">
                                    <img src="<?php echo e(asset('companyprofile/assets/Photos/Only Icon/Product Return.png')); ?>" alt="">
                                </div>
                                <div class="service-one__content">

                                    <h2 class="service-one__title"><a href="ProductReturn.html">-See More-</a></h2>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="500ms">
                        <a href="ConsultingService.html">
                            <div class="services-one__single">
                                <div class="service-one__img">
                                    <img src="<?php echo e(asset('companyprofile/assets/Photos/Only Icon/Consulting Service.png')); ?>" alt="">
                                </div>
                                <div class="service-one__content">

                                    <h2 class="service-one__title"><a href="ConsultingService.html">-See More-</a></h2>
                    ...
                    <!--Services One Single Start-->
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="600ms">
                        <a href="ContractorInformation.html">
                            <div class="services-one__single">
                                <div class="service-one__img">
                                    <img src="<?php echo e(asset('companyprofile/assets/Photos/Only Icon/Contractor Information.png')); ?>" alt="">
                                </div>
                                <div class="service-one__content">

                                    <h2 class="service-one__title"><a href="ContractorInformation.html">-See More-</a></h2>
                    ...
                    <!--Services One Single Start-->
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="700ms">
                        <a href="MemberService.html">
                            <div class="services-one__single">
                                <div class="service-one__img">
                                    <img src="<?php echo e(asset('companyprofile/assets/Photos/Only Icon/Member Service.png')); ?>" alt="">
                                </div>
                                <div class="service-one__content">

                                    <h2 class="service-one__title"><a href="MemberService.html">-See More-</a></h2>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="800ms">
                        <a href="RepairService.html">
                            <div class="services-one__single">
                                <div class="service-one__img">
                                    <img src="<?php echo e(asset('companyprofile/assets/Photos/Only Icon/Power Tools Repair Service_2.png')); ?>" alt="">
                                </div>
                                <div class="service-one__content">

                                    <h2 class="service-one__title"><a href="RepairService.html">-See More-</a></h2>
    ...
    <section class="download mt-5">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-7 col-lg-6">
                    <div class="download__left">
                        <p class="download__sub-title">Get our member application free now!</p>
                        <h1 class="download__title">Download our application</h1>
                        <div class="download__apps">
                            <div class="download__app-one">
                ...
                <div class="col-xl-5 col-lg-6">
                    <div class="download__right">
                        <div class="download__img wow slideInRight" data-wow-delay="100ms" data-wow-duration="2500ms">
                            <img src="<?php echo e(asset('companyprofile/assets/Photos/memberapp.png')); ?>" alt="">
                            <div class="download__badge">
    ...
    <section class="ourcenter mt-5" id="ourCenter">
        <div class="container">
            ...
            <div class="section-sub-title-box">
                ...
                <!-- <div class="section-title-shape-1">
                    <img src="companyprofile/assets/images/shapes/section-title-shape-1.png" alt="">
                </div>
                <div class="section-title-shape-2">
                    <img src="companyprofile/assets/images/shapes/section-title-shape-2.png" alt="">
                </div> -->
            </div>
            <div class="row filter-layout masonary-layout mt-3">
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra busi insur">
                    <div class="portfolio__single">
                        <div class="portfolio__img">
                            <img src="<?php echo e(asset('companyprofile/assets/Photos/lanthit.png')); ?>" alt="">
                            <div class="portfolio__plus">
                                <a href="<?php echo e(asset('companyprofile/assets/Photos/lanthit.png')); ?>" class="img-popup"><span class="icon-plus"></span></a>
                            </div>
                            <div class="portfolio__content">
                                <p class="portfolio__sub-title">Lanthit Branch, Yangon</p>
                                <h4 class="portfolio__title"><a href="LanthitInfo.html">Show Deatil</a></h4>
                            </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra busi insur">
                    <div class="portfolio__single">
                        <div class="portfolio__img">
                            <img src="<?php echo e(asset('companyprofile/assets/Photos/satsan.png')); ?>" alt="">
                            <div class="portfolio__plus">
                                <a href="<?php echo e(asset('companyprofile/assets/Photos/satsan.png')); ?>" class="img-popup"><span class="icon-plus"></span></a>
                            </div>
                            <div class="portfolio__content">
                                <p class="portfolio__sub-title">Satsan Branch, Yangon</p>
                                <h4 class="portfolio__title"><a href="SatsanInfo.html">Show Deatil</a></h4>
                            </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra busi poli">
                    <div class="portfolio__single">
                        <div class="portfolio__img">
                            <img src="<?php echo e(asset('companyprofile/assets/Photos/eastdagon.png')); ?>" alt="">
                            <div class="portfolio__plus">
                                <a href="<?php echo e(asset('companyprofile/assets/Photos/eastdagon.png')); ?>" class="img-popup"><span class="icon-plus"></span></a>
                            </div>
                            <div class="portfolio__content">
                                <p class="portfolio__sub-title">East Dagon Branch, Yangon</p>
                                <h4 class="portfolio__title"><a href="EastdagonInfo.html">Show Deatil</a></h4>
                            </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra busi poli">
                    <div class="portfolio__single">
                        <div class="portfolio__img">
                            <img src="<?php echo e(asset('companyprofile/assets/Photos/hlaingtharyar.png')); ?>" alt="">
                            <div class="portfolio__plus">
                                <a href="<?php echo e(asset('companyprofile/assets/Photos/hlaingtharyar.png')); ?>" class="img-popup"><span class="icon-plus"></span></a>
                            </div>
                            <div class="portfolio__content">
                                <p class="portfolio__sub-title">HlaingTharYar Branch, Yangon</p>
                                <h4 class="portfolio__title"><a href="HlaingtharyarInfo.html">Show Deatil</a></h4>
                            </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra busi poli">
                    <div class="portfolio__single">
                        <div class="portfolio__img">
                            <img src="<?php echo e(asset('companyprofile/assets/Photos/terminal.jpg')); ?>" alt="">
                            <div class="portfolio__plus">
                                <a href="<?php echo e(asset('companyprofile/assets/Photos/terminal.jpg')); ?>" class="img-popup"><span class="icon-plus"></span></a>
                            </div>
                            <div class="portfolio__content">
                                <p class="portfolio__sub-title">PRO 1 PLUS Terminal M Branch, Yangon</p>
                                <h4 class="portfolio__title"><a href="TerminalInfo.html">Show Deatil</a></h4>
                            </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra busi poli">
                    <div class="portfolio__single">
                        <div class="portfolio__img">
                            <img src="<?php echo e(asset('companyprofile/assets/Photos/southdagon.jpg')); ?>" alt="">
                            <div class="portfolio__plus">
                                <a href="<?php echo e(asset('companyprofile/assets/Photos/southdagon.jpg')); ?>" class="img-popup"><span class="icon-plus"></span></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra busi poli">
                    <div class="portfolio__single">
                        <div class="portfolio__img">
                            <img src="<?php echo e(asset('companyprofile/assets/Photos/shwepyithar.jpg')); ?>" alt="">
                            <div class="portfolio__plus">
                                <a href="<?php echo e(asset('companyprofile/assets/Photos/shwepyithar.jpg')); ?>" class="img-popup"><span class="icon-plus"></span></a>
                            </div>
                            <div class="portfolio__content">
    ...
    <section class="ourcenter mt-5" id="ourCenter">
        <div class="container">
            ...
            <div class="row filter-layout masonary-layout mt-3">
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra busi insur">
                    <div class="portfolio__img">
                        <img src="<?php echo e(asset('companyprofile/assets/Photos/theikpan.png')); ?>" alt="">
                        <div class="portfolio__plus">
                            <a href="<?php echo e(asset('companyprofile/assets/Photos/theikpan.png')); ?>" class="img-popup"><span class="icon-plus"></span></a>
                        </div>
                        <div class="portfolio__content">
                            <p class="portfolio__sub-title">Theikpan, Mandalay</p>
                            <h4 class="portfolio__title"><a href="TampawadyInfo.html">Show Deatil</a></h4>
                        </div>
                        <div>&nbsp;PRO 1 Global Home Center (Mandalay Branch )</div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra busi insur">
                    <div class="portfolio__single">
                        <div class="portfolio__img">
                            <img src="<?php echo e(asset('companyprofile/assets/Photos/tampawady.png')); ?>" alt="">
                            <div class="portfolio__plus">
                                <a href="<?php echo e(asset('companyprofile/assets/Photos/tampawady.png')); ?>" class="img-popup"><span class="icon-plus"></span></a>
                            </div>
                            <div class="portfolio__content">
                                <p class="portfolio__sub-title">Tampawady Branch, Yangon</p>
                                <h4 class="portfolio__title"><a href="TampawadyInfo.html">Show Deatil</a></h4>
                            </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row filter-layout masonary-layout mt-3">
                            <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra busi insur">
                                <div class="portfolio__single">
                                    <div class="portfolio__img">
                                        <img src="<?php echo e(asset('companyprofile/assets/Photos/bago.jpg')); ?>" alt="">
                                        <div class="portfolio__plus">
                                            <a href="<?php echo e(asset('companyprofile/assets/Photos/bago.jpg')); ?>" class="img-popup"><span class="icon-plus"></span></a>
                                        </div>
                                        <div class="portfolio__content">
                                            <p class="portfolio__sub-title">Bago Branch, Mandalay</p>
                                            <h4 class="portfolio__title"><a href="">Show Deatil</a></h4>
                                        </div>
                            ...
                            <section class="ourcenter mt-5" id="ourCenter">
                                <div class="container">
                                    <div class="section-sub-title-box">
                                       <h3 class="section-sub-title"><i class="fas fa-map-marker-alt p-2"></i>Mawlamyine<i class="fas fa-map-marker-alt px-2"></i></h3>
                                    </div>
                                    <div class="row filter-layout masonary-layout mt-3">
                                        <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra busi insur">
                                            <div class="portfolio__single">
    ...
    <section class="ourpatner mt-5" id="ourPatner">
        <div class="container">
                        ...
                        <div class="owl-carousel owl-theme thm-owl__carousel testimonial-one__carousel" data-owl-options='{
                                ...
                                <div class="testimonial-one__single">
                                    <div class="testimonial-one__single-inner">
                                        ...
                                        <div class="partaner mb-5">
                                            <h6>"BANGKOK CABLE COMPANY LIMITED"</h6>
                                        </div>
                                        <div class="testimonial-one__client-info">
                                            <a target="_blank" href="https://pro1globalhomecenter.com/product-list.html?divisionId=2&townshipId=1&sortBy=1&searchText=BCC">
                                                <div class=>
                                                    <img src="<?php echo e(asset('companyprofile/assets/Photos/Brands/B1.png')); ?>" alt=""></a>
                                            <!-- <div class="testimonial-one__quote">
                                                <img src="companyprofile/assets/images/testimonial/testimonial-1-quote.png" alt="">
                                            </div> -->
                                            </div>
                                            <div class="testimonial-one__client-content">

                                                <div class="testimonial-one__client-details">
                                                    <!-- <h3 class="testimonial-one__client-name">BANGKOK CABLE</h3> -->
                                        ...
                                        <div class="testimonial-one__client-info">
                                            <div class=>
                                                <a target="_blank" href="https://pro1globalhomecenter.com/product-list.html?divisionId=1&townshipId=18&sortBy=1&searchText=OPPLE">
                                                    <img src="<?php echo e(asset('companyprofile/assets/Photos/Brands/B2.png')); ?>" alt=""></a>
                                                <!-- <div class="testimonial-one__quote">
                                                    <img src="companyprofile/assets/images/testimonial/testimonial-1-quote.png" alt="">
                                                </div> -->
                                            </div>
                            ...
                            <div class="item">
                                <div class="testimonial-one__single">
                                    <div class="testimonial-one__single-inner">
                                        <div class="testimonial-one__shape-1">
                                            <img src="<?php echo e(asset('companyprofile/assets/images/shapes/testimonial-one-shape-1.png')); ?>" alt="">
                                        </div>
                                        <div class="partaner mb-5">
                                        ...
                                        <div class="testimonial-one__client-info">
                                            <div class=>
                                                <a target="_blank" href="https://pro1globalhomecenter.com/product-list.html?divisionId=1&townshipId=18&brandId=49">
                                                    <img src="<?php echo e(asset('companyprofile/assets/Photos/Brands/B3.png')); ?>" alt=""></a>
                                                <!-- <div class="testimonial-one__quote">
                                                    <img src="companyprofile/assets/images/testimonial/testimonial-1-quote.png" alt="">
                                                </div> -->
                                            </div>
                            ...
                            <!-- <div class="item">
                                <div class="testimonial-one__single">
                                    <div class="testimonial-one__single-inner">
                                        <div class="testimonial-one__shape-1">
                                            <img src="companyprofile/assets/images/shapes/testimonial-one-shape-1.png" alt="">
                                        </div>
                                        <div class="testimonial-one__client-info">
                                            <div class="testimonial-one__client-img-box">
                                                <img src="companyprofile/assets/Photos/Brands/B8.png" alt="">
                                                <div class="testimonial-one__quote">
                                                    <img src="companyprofile/assets/images/testimonial/testimonial-1-quote.png" alt="">
                                                </div>
                                            </div>
                                        ...
                                        <div class="testimonial-one__client-info">
                                            <div class=>
                                                <a target="_blank" href="https://pro1globalhomecenter.com/product-list.html?divisionId=1&townshipId=18&brandId=82">
                                                    <img src="<?php echo e(asset('companyprofile/assets/Photos/Brands/B5.png')); ?>" alt=""></a>
                                                <!-- <div class="testimonial-one__quote">
                                                    <img src="companyprofile/assets/images/testimonial/testimonial-1-quote.png" alt="">
                                                </div> -->
                                            </div>
                                        ...
                                        <div class="testimonial-one__client-info">
                                            <div class=>
                                                <a target="_blank" href="https://pro1globalhomecenter.com/product-list.html?divisionId=1&townshipId=18&brandId=81">
                                                    <img src="<?php echo e(asset('companyprofile/assets/Photos/Brands/B6.png')); ?>" alt=""></a>
                                                <!-- <div class="testimonial-one__quote">
                                                    <img src="companyprofile/assets/images/testimonial/testimonial-1-quote.png" alt="">
                                                </div> -->
                                            </div>
                                        ...
                                        <div class="testimonial-one__client-info">
                                            <div class=>
                                                <a target="_blank" href="https://pro1globalhomecenter.com/product-list.html?divisionId=1&townshipId=18&brandId=87">
                                                    <img src="<?php echo e(asset('companyprofile/assets/Photos/Brands/B7.jpg')); ?>" alt=""></a>
                                            </div>
                                            <div class="testimonial-one__client-content">
        ...
        <div class="container">
            ...
            <div class="row filter-layout masonary-layout">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item busi custom-img">
                    <div class="portfolio__single">
                        <div class="">
                            <img src="<?php echo e(asset('companyprofile/assets/Photos/act1.png')); ?>" alt="">
                            <div class="">
                                <a href="<?php echo e(asset('companyprofile/assets/Photos/act1.png')); ?>" class="img-popup"></a>
                            </div>
                            <div>
                                <ul class="list-unstyled about-one__points">
                                <li>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item busi custom-img">
                    <div class="portfolio__single">
                        <div class="">
                            <img src="<?php echo e(asset('companyprofile/assets/Photos/act2.png')); ?>" alt="">
                            <div class="">
                                <a href="<?php echo e(asset('companyprofile/assets/Photos/act2.png')); ?>" class="img-popup"><span class=""></span></a>
                            </div>
                            <div>
                               <ul class="list-unstyled about-one__points">
                                <li>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item busi custom-img">
                    <div class="portfolio__single">
                        <div class="">
                            <img src="<?php echo e(asset('companyprofile/assets/Photos/act3.png')); ?>" alt="">
                            <div class="">
                                <a href="<?php echo e(asset('companyprofile/assets/Photos/act3.png')); ?>" class="img-popup"><span class=""></span></a>
                            </div>
                            <div>
                                <ul class="list-unstyled about-one__points">
                                <li>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item busi custom-img">
                    <div class="portfolio__single">
                        <div class="">
                            <img src="<?php echo e(asset('companyprofile/assets/Photos/act4.png')); ?>" alt="">
                            <div class="">
                                <a href="<?php echo e(asset('companyprofile/assets/Photos/act4.png')); ?>" class="img-popup"><span class=""></span></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item busi custom-img">
                    <div class="portfolio__single">
                        <div class="">
                            <img src="<?php echo e(asset('companyprofile/assets/Photos/act5.png')); ?>" alt="">
                            <div class="">
                                <a href="<?php echo e(asset('companyprofile/assets/Photos/act5.png')); ?>" class="img-popup"><span class=""></span></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item busi custom-img">
                    <div class="portfolio__single">
                        <div class="">
                            <img src="<?php echo e(asset('companyprofile/assets/Photos/act6.png')); ?>" alt="">
                            <div class="">
                                <a href="<?php echo e(asset('companyprofile/assets/Photos/act6.png')); ?>" class="img-popup"><span class=""></span></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra custom-img">
                    <div class="portfolio__single">
                        <div class="portfolio__img">
                            <img src="<?php echo e(asset('companyprofile/assets/Photos/training1.pn')); ?>g" alt="">
                            <div class="">
                                <a href="<?php echo e(asset('companyprofile/assets/Photos/training1.png')); ?>" class="img-popup"><span class=""></span></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra custom-img">
                    <div class="portfolio__single">
                        <div class="portfolio__img">
                            <img src="<?php echo e(asset('companyprofile/assets/Photos/training2.png')); ?>" alt="">
                            <div class="">
                                <a href="<?php echo e(asset('companyprofile/assets/Photos/training2.png')); ?>" class="img-popup"><span class=""></span></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra custom-img">
                    <div class="portfolio__single">
                        <div class="portfolio__img">
                            <img src="<?php echo e(asset('companyprofile/assets/Photos/training3.png')); ?>" alt="">
                            <div class="">
                                <a href="<?php echo e(asset('companyprofile/assets/Photos/training3.png')); ?>" class="img-popup"><span class=""></span></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra custom-img">
                    <div class="portfolio__single">
                        <div class="">
                            <img src="<?php echo e(asset('companyprofile/assets/Photos/act17.png')); ?>" alt="">
                            <div class="">
                                <a href="<?php echo e(asset('companyprofile/assets/Photos/act17.png')); ?>" class="img-popup"><span class=""></span></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra custom-img">
                    <div class="portfolio__single">
                        <div class="">
                            <img src="<?php echo e(asset('companyprofile/assets/Photos/act10.png')); ?>" alt="">
                            <div class="">
                                <a href="<?php echo e(asset('companyprofile/assets/Photos/act10.png')); ?>" class="img-popup"><span class=""></span></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra custom-img">
                    <div class="portfolio__single">
                        <div class="">
                            <img src="<?php echo e(asset('companyprofile/assets/Photos/act18.png')); ?>" alt="">
                            <div class="">
                                <a href="<?php echo e(asset('companyprofile/assets/Photos/act18.png')); ?>" class="img-popup"><span class=""></span></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra custom-img">
                    <div class="portfolio__single">
                        <div class="">
                            <img src="<?php echo e(asset('companyprofile/assets/Photos/act13.png')); ?>" alt="">
                            <div class="">
                                <a href="<?php echo e(asset('companyprofile/assets/Photos/act13.png')); ?>" class="img-popup"><span class=""></span></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra custom-img">
                    <div class="portfolio__single">
                        <div class="">
                            <img src="<?php echo e(asset('companyprofile/assets/Photos/act12.png')); ?>" alt="">
                            <div class="">
                                <a href="<?php echo e(asset('companyprofile/assets/Photos/act12.png')); ?>" class="img-popup"><span class=""></span></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra custom-img">
                    <div class="portfolio__single">
                        <div class="">
                            <img src="<?php echo e(asset('companyprofile/assets/Photos/act11.png')); ?>" alt="">
                            <div class="">
                                <a href="<?php echo e(asset('companyprofile/assets/Photos/act11.png')); ?>" class="img-popup"><span class=""></span></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra custom-img">
                    <div class="portfolio__single">
                        <div class="">
                            <img src="<?php echo e(asset('companyprofile/assets/Photos/act16.png')); ?>" alt="">
                            <div class="">
                                <a href="<?php echo e(asset('companyprofile/assets/Photos/act16.png')); ?>" class="img-popup"><span class=""></span></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra custom-img">
                    <div class="portfolio__single">
                        <div class="">
                            <img src="<?php echo e(asset('companyprofile/assets/Photos/act14.png')); ?>" alt="">
                            <div class="">
                                <a href="<?php echo e(asset('companyprofile/assets/Photos/act14.png')); ?>" class="img-popup"><span class=""></span></a>
                            </div>
                            <div class="portfolio__content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra custom-img">
                    <div class="portfolio__single">
                        <div class="">
                            <img src="<?php echo e(asset('companyprofile/assets/Photos/act15.png')); ?>" alt="">
                            <div class="">
                                <a href="<?php echo e(asset('companyprofile/assets/Photos/act15.png')); ?>" class="img-popup"><span class=""></span></a>
                            </div>
                            <div class="portfolio__content">
    ...
    <div class="page-wrapper">
                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="contact-page__right">
                            <div class="contact-page__form">
                                <form action="<?php echo e(asset('companyprofile/assets/inc/sendemail.php')); ?>" class="comment-one__form contact-form-validated"
        ...
        <!-- <section class="google-map-two">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d12841.48991567905!2d96.11949486839116!3d16.885878785601413!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30c1944a6f25f413%3A0x9c75e4d568eb20a1!2sPRO%201%20Global%20Home%20Center%20-%20Lanthit%20Branch!5e0!3m2!1sen!2smm!4v1636541670063!5m2!1sen!2smm" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
        </section> -->
        </div>
        <footer class="site-footer">
        <div class="site-footer-bg " style="background-image: url<?php echo e(asset('companyprofile/assets/images/backgrounds/site-footer-bg.png')); ?>; ">
        </div>
        <div class="container ">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp " data-wow-delay="100ms ">
                        <div class="footer-widget__column footer-widget__about ">
                            <div class="footer-widget__logo ">
                                <a href="Index-Boxed.html"><img src="<?php echo e(asset('companyprofile/assets/Photos/footerlogo.png')); ?> " alt=" " width="200px " height="70px "></a>
                            </div>
                            ...
                            <div class="footer-widget__about-text-box ">
                                <p class="footer-widget__about-text ">PRO 1 Global Home Center is the first and largest company<br> selling home building products in Myanmar. </p>

                            </div>

                            <!-- <div class="site-footer__social ">
                                <a target="_blank " href="https://www.facebook.com/pro1homecenter/ "><i class="fab fa-facebook "></i></a>
                                <a target="_blank " href="https://www.youtube.com/channel/UCvTMpi4etgXlCdnIEMkO8Ig "><i class="fa fa-youtube " aria-hidden="true "></i></i></a>
                                <a target="_blank " href="https://invite.viber.com/?g2=AQB%2BIxt%2BiHONWkjqz%2FbmgmTW2jaFd73U66dVh7ZdzTh5iUk5ZWHHexew8X%2F%2FPIXM "><i class="fab fa-viber "></i></a>
                                <a target="_blank " href="https://www.instagram.com/pro1_global_home_center/?igshid=YmMyMTA2M2Y%3D "><i class="fab fa-instagram "></i></a>
                            </div> -->
                        </div>
                        ...
                        <div class="footer-widget__column footer-widget__contact clearfix ">
                            ...
                            <ul class="footer-widget__contact-list list-unstyled clearfix ">
                                <li>
                                    ...
                                    <div class="text ">
                                        <p><a href="mailto:needhelp@company.com ">info@pro1globalhomecenter.com</a></p>
                                    </div>
                                </li>
                                <li>
                                    <div class="icon ">
                                    ...
                                    <div class="text ">
                                        <p>Near Arlain Ngar Sint Pagoda, Lanthit, Insein</p>
                                    </div>
                                </li>
                            </ul>
                            <div class="footer-widget__open-hour ">
                                <h3 class="footer-widget__open-hour-title ">Open Hours</h3>
                                <h3 class="footer-widget__open-hour-text ">Mon – Sat: 8:00 am to 6:00 pm Sunday: Closed
                                </h3>
                            </div>
                        </div>
                    </div>
                            ...
                            <ul class="footer-widget__gallery-list list-unstyled clearfix ">
                                <li class="col-md-4 ">
                                    ...
                                    <div class="footer-widget__gallery-img ">
                                        ...
                                        <img src="<?php echo e(asset('companyprofile/assets/Photos/sc-fb8.png')); ?> " alt=" ">
                                ...
                                <li class="col-md-4 ">
                                    <div class="footer-widget__gallery-img ">
                                        <img src="<?php echo e(asset('companyprofile/assets/Photos/sc-vb6.png')); ?> " alt=" ">
                                ...
                                <li class="col-md-4 ">
                                    <div class="footer-widget__gallery-img ">
                                        <img src="<?php echo e(asset('companyprofile/assets/Photos/sc-yt1.png ')); ?>" alt=" ">
                                        <a target="_blank" href="https://www.youtube.com/channel/UCvTMpi4etgXlCdnIEMkO8Ig "><span class="fa fa-link "></span></a>
                                    </div>
                                </li>
                                <li class="col-md-4 ">
                                    <div class="footer-widget__gallery-img ">
                                        <img src="<?php echo e(asset('companyprofile/assets/Photos/sc-yt3.png')); ?> " alt=" ">
                        ...
                        <div class="footer-widget__column footer-widget__newsletter ">
                            ...
                            <div class="footer-widget__phone ">
                                <div class="footer-widget__phone-icon ">
                                    <a href="tel:959428751328 "><span class="icon-telephone "></span></a>
                                </div>
                ...
                <div class="row ">
                    <div class="col-xl-12 ">
                        <div class="site-footer__bottom-inner ">
                            <p class="site-footer__bottom-text ">© All Copyright 2022 by <a href="# ">PRO1 Global Company</a>
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <div class="mobile-nav__wrapper ">
        ...
        <div class="mobile-nav__content ">
            ...
            <div class="logo-box ">
                <a href="index.html " aria-label="logo image "><img src="<?php echo e(asset('companyprofile/assets/Photos/PRO1LOGO (2).png ')); ?>" width="143 " alt=" " /></a>
            </div>
            ...
            <ul class="mobile-nav__contact list-unstyled ">
                ...
                <li>
                    ...
                    <a href="tel:666-888-0000 ">+959428751328</a>
                </li>
            </ul>
            <!-- /.mobile-nav__contact -->
            <div class="mobile-nav__top ">
                <div class="mobile-nav__social ">
                    <a target="_blank" href="https://invite.viber.com/?g2=AQB%2BIxt%2BiHONWkjqz%2FbmgmTW2jaFd73U66dVh7ZdzTh5iUk5ZWHHexew8X%2F%2FPIXM" class="fab fa-viber "></a>
                    <a target="_blank" href="https://www.facebook.com/pro1homecenter/" class="fab fa-facebook-square "></a>
                    <a target="_blank" href="https://www.youtube.com/channel/UCvTMpi4etgXlCdnIEMkO8Ig" class="fa fa-youtube" aria-hidden="true"></a>
                    <a target="_blank" href="https://instagram.com/pro1_global_home_center?igshid=YmMyMTA2M2Y=" class="fab fa-instagram "></a>
                </div>
                <!-- /.mobile-nav__social -->
            </div>
            <!-- /.mobile-nav__top -->
    ...
    <script src="<?php echo e(asset('companyprofile/assets/vendors/jquery/jquery-3.6.0.min.js ')); ?>"></script>
    <script src="<?php echo e(asset('companyprofile/assets/vendors/bootstrap/js/bootstrap.bundle.min.js')); ?> "></script>
    <script src="<?php echo e(asset('companyprofile/assets/vendors/jarallax/jarallax.min.js ')); ?>"></script>
    <script src="<?php echo e(asset('companyprofile/assets/vendors/jquery-ajaxchimp/jquery.ajaxchimp.min.js')); ?> "></script>
    <script src="<?php echo e(asset('companyprofile/assets/vendors/jquery-appear/jquery.appear.min.js ')); ?>"></script>
    <script src="<?php echo e(asset('companyprofile/assets/vendors/jquery-circle-progress/jquery.circle-progress.min.js ')); ?>"></script>
    <script src="<?php echo e(asset('companyprofile/assets/vendors/jquery-magnific-popup/jquery.magnific-popup.min.js ')); ?>"></script>
    <script src="<?php echo e(asset('companyprofile/assets/vendors/jquery-validate/jquery.validate.min.js')); ?> "></script>
    <script src="<?php echo e(asset('companyprofile/assets/vendors/nouislider/nouislider.min.js ')); ?>"></script>
    <script src="<?php echo e(asset('companyprofile/assets/vendors/odometer/odometer.min.js ')); ?>"></script>
    <script src="<?php echo e(asset('companyprofile/assets/vendors/swiper/swiper.min.js ')); ?>"></script>
    <script src="<?php echo e(asset('companyprofile/assets/vendors/tiny-slider/tiny-slider.min.js ')); ?>"></script>
    <script src="<?php echo e(asset('companyprofile/assets/vendors/wnumb/wNumb.min.js ')); ?>"></script>
    <script src="<?php echo e(asset('companyprofile/assets/vendors/wow/wow.js')); ?> "></script>
    <script src="<?php echo e(asset('companyprofile/assets/vendors/isotope/isotope.js ')); ?>"></script>
    <script src="<?php echo e(asset('companyprofile/assets/vendors/countdown/countdown.min.js')); ?> "></script>
    <script src="<?php echo e(asset('companyprofile/assets/vendors/owl-carousel/owl.carousel.min.js')); ?> "></script>
    <script src="<?php echo e(asset('companyprofile/assets/vendors/bxslider/jquery.bxslider.min.js ')); ?>"></script>
    <script src="<?php echo e(asset('companyprofile/assets/vendors/bootstrap-select/js/bootstrap-select.min.js ')); ?>"></script>
    <script src="<?php echo e(asset('companyprofile/assets/vendors/vegas/vegas.min.js ')); ?>"></script>
    <script src="<?php echo e(asset('companyprofile/assets/vendors/jquery-ui/jquery-ui.js ')); ?>"></script>
    <script src="<?php echo e(asset('companyprofile/assets/vendors/timepicker/timePicker.js ')); ?>"></script>
    <script src="<?php echo e(asset('companyprofile/assets/vendors/circleType/jquery.circleType.js ')); ?>"></script>
    <script src="<?php echo e(asset('companyprofile/assets/vendors/circleType/jquery.lettering.min.js ')); ?>"></script>

    <!-- template js -->
    <script src="<?php echo e(asset('companyprofile/assets/js/insur.js')); ?> "></script>
</body>

</html>
<?php /**PATH C:\xampp\htdocs\company-profile\resources\views/Index-Boxed.blade.php ENDPATH**/ ?>