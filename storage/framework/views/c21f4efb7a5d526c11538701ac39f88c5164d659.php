                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="news-details__left">
                        <div class="news-details__img">
                            <img src="<?php echo e(asset('assets/photos/currentbranch.jpg')); ?>" alt="">
                        </div>
                            ...
                            <ul class="sidebar__post-list list-unstyled">
                                <li>
                                    <a target="_blank" href="https://www.facebook.com/pro1homecenter/">
                                        <div class="sidebar__post-image">
                                            <img src="<?php echo e(asset('assets/photos/facebook6.jpg')); ?>" alt="">
                                        </div>
                                ...
                                <li>
                                    <a target="_blank" href="https://invite.viber.com/?g2=AQB%2BIxt%2BiHONWkjqz%2FbmgmTW2jaFd73U66dVh7ZdzTh5iUk5ZWHHexew8X%2F%2FPIXM">
                                        <div class="sidebar__post-image">
                                            <img src="<?php echo e(asset('assets/photos/viber2.jpg')); ?>" alt="">
                                        </div>
                                        <div class="sidebar__post-content">
                                            <h3>
                                                <span class="sidebar__post-content-meta"><i class="far fa-user-circle"></i> by Admin</span>
                                ...
                                <li>
                                    <a target="_blank" href="https://www.youtube.com/channel/UCvTMpi4etgXlCdnIEMkO8Ig">
                                        <div class="sidebar__post-image">
                                            <img src="<?php echo e(asset('assets/photos/youtube7.jpg')); ?>" alt="">
                                        </div>
                                        <div class="sidebar__post-content">
                                            <h3>
                                                <span class="sidebar__post-content-meta"><i class="far fa-user-circle"></i> by Admin</span>
                                ...
                                <li>
                                    <a target="_blank" href="https://instagram.com/pro1_global_home_center?igshid=YmMyMTA2M2Y=">
                                        <div class="sidebar__post-image">
                                            <img src="<?php echo e(asset('assets/photos/instagram2.jpg')); ?>" alt="">
                                        </div>
                                        <div class="sidebar__post-content">
                                            <h3>
                                                <span class="sidebar__post-content-meta"><i class="far fa-user-circle"></i> by Admin</span>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\company-profile\resources\views/establish_year.blade.php ENDPATH**/ ?>